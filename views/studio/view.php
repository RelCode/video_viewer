<div class="container-fluid p-0" id="main-container">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-9 p-3 sub-container">
            <a href="?page=studio&subpage=create" class="btn btn-primary col-xs-12"><i class="fa fa-plus"></i> Add Video</a>
            <?php
                if(count($data) > 0){
                    ?>
                        <div class="row m-0">
                            <?php
                                ...
                                foreach ($data as $video) {
                                    $div .= '<a href="?page=watch&id='.$video['video_id'].'" class="col-xs-12 col-md-3 p-3 press-to-video">';
                                    $div .= '<div class="card">';
